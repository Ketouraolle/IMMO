...
<div class="row">
    <div class="col-6 mb-3">
        <label class="form-label">Visit fee (XAF)</label>
        ...
        <div class="form-text">Paid by visitors online or at the visit. 0 = free.</div>
    </div>
    <div class="col-6 mb-3">
        ...
        <div class="form-text">Agency share of each rent payment.</div>
    </div>
</div>
<div class="mb-3">
